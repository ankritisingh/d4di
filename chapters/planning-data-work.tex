...
\texttt{iefolder} sets up your project folder according to DIME Analytic's folder 
template, although we understand that this template does not fit all projects. There
are project at DIME that are too different to use this template, but the point is that
it is important to carefully plan your project folder, and DIME Analytic's folder
